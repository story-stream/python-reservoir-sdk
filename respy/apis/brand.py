...
class BrandAPI(object):
    """
    Provides an interface for accessing the brand related endpoints within the reservoir API.
    You should not instantiate this class directly; use the
    :meth:'reservoir.Reservoir.brand' method instead.
    """

    def __init__(self, client):
        """
        Initializes a new instance of the brand api using the provided 'client'
    ...
    def all(self, story, feeds, q=None, categories=None, tags=None,
        ...
        """
        Returns a collection of brand content items from a network within the reservoir along with
        ...
        :param older_than: Only fetch brand items that are older than this date.
        :param newer_than: Only fetch brand items that are newer than this date.
        :param limit: Only fetch this number of brand items.
        ...
        :return: A collection of brand items.
        """
    ...
    def _build_url(self, story):
        """
        Builds a formatted URL for any of the brand end points.
        :param story: The story ID.
        :return: A URL string.
        """
        return u'/api/items/{}/brand/'.format(story)
